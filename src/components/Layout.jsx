...
export default function Layout() {
  ...
  useEffect(() => {
    supabase
      ...
      .limit(1)
      .then(({ data }) => {
        if (data?.[0]) setUltimaSync(data[0]);
      });
  }, []);
    ...
    >
      <aside
        style={{
          width: "220px",
          background: "var(--blk2)",
          borderRight: "1px solid var(--blk4)",
          display: "flex",
      ...
      >
        ...
        <nav style={{ flex: 1, padding: "12px 8px" }}>
          ...
          <NavLink to="/guias" style={linkStyle}>
            <span>◈</span> Guías
          </NavLink>
        ...
        >
          ...
          >
            ...
            ></div>
            <span style={{ fontSize: "10px", color: "var(--m)" }}>
              Carga manual activa
            </span>
          </div>
          {ultimaSync ? (
            ...
            >
              Última carga:{" "}
              {new Date(ultimaSync.created_at).toLocaleString("es-CO", {
                dateStyle: "short",
                timeStyle: "short",
              })}
              <br />
              ...
              · {ultimaSync.guias_actualizadas} actualizadas
            </div>
          ) : (
        ...
        <div
          style={{ padding: "12px 8px", borderTop: "1px solid var(--blk4)" }}
        >
          <div
            style={{
              display: "flex",

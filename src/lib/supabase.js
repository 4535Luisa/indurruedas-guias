...
export const ESTADOS = {
  en_transito: { label: 'En tránsito', color: '#55AAFF', bg: '#001a33', border: '#003366' },
  entregado: { label: 'Entregado', color: '#AAFF00', bg: '#0d1f00', border: '#1a3300' },
  pendiente: { label: 'Pendiente recogida', color: '#FFAA00', bg: '#2a1800', border: '#3d2400' },
  novedad: { label: 'Con novedad', color: '#FF5555', bg: '#2a0000', border: '#440000' },
  informada: { label: 'Informada a TCC', color: '#888888', bg: '#1a1a1a', border: '#2e2e2e' },
  no_despachada: { label: 'No despachada', color: '#FF8800', bg: '#2a1200', border: '#3d1a00' },
}

export const TRANSPORTADORAS = {
  estelar: { label: 'Estelar Express', color: '#AAFF00', bg: '#0d1f00', border: '#1a3300' },
